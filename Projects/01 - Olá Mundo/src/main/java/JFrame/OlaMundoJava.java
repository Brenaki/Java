...
public class OlaMundoJava extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblMessagem.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblMessagem.setForeground(new java.awt.Color(255, 0, 51));
        lblMessagem.setText("Aqui vai aparecer a messagem");
        lblMessagem.setToolTipText("");

        btnClick.setText("Clique em Mim");
        btnClick.setActionCommand("Button");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(39, 39, 39)
                .addComponent(lblMessagem, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(btnClick)
